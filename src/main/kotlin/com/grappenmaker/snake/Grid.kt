...
// Partially taken from my advent of code library
// https://github.com/770grappenmaker/advent-of-code
...
enum class Direction(val dx: Int, val dy: Int) {
    // Different from aoc: board is upside down
...
val Plane.topLeftCorner get() = Point(0, height - 1)
val Plane.topRightCorner get() = Point(width - 1, height - 1)
val Plane.bottomLeftCorner get() = Point(0, 0)
val Plane.bottomRightCorner get() = Point(width - 1, 0)
